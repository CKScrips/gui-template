local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/
source')))()

local Window = OrionLib:MakeWindow({Name = "CKScripHub | Adopt Me Hub", HidePremium = false, IntroText = 
"CKScripHub", SaveConfig = true, ConfigFolder = "AdoptMeConfig"})
...
TradeTab:AddParagraph("cont.","This trade needs to look convincing. You must have pets of value so your 
victim will accept.")
...
ChangerTab:AddParagraph("Pets do not stay MFR/NFR","If you try to trade them, they will show up as normal 
pets.")
